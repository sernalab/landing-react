          ...
          <div className="hs-carousel-body absolute top-0 bottom-0 start-0 flex flex-nowrap transition-transform duration-700 opacity-0">
            <div className="hs-carousel-slide">
              <div className="flex justify-center bg-gray-100 p-6">
                <span className="self-center text-4xl transition duration-700">
                  <img
                    src="https://www.joma-tools.com/catalogo/modules/ps_imageslider/images/a2616d73ad1bf649d83290be50e677b9f2a65585_Banner_1.jpg"
                    alt=""
                  />
                </span>
              </div>
            ...
            <div className="hs-carousel-slide">
              <div className="flex justify-center h-full bg-gray-200 p-6">
                <span className="self-center text-4xl transition duration-700">
                  <img
                    src="https://www.joma-tools.com/catalogo/modules/ps_imageslider/images/e573ac5d69238edb669ae0e7231f4763cf710a46_Banner_2.jpg"
                    alt=""
                  />
                </span>
              </div>
